    ...
    async function listarUsuarios()
    {
        ...
        usuarios.forEach(usuario => {
            ...
            li.innerHTML = `
                ...
                <div class="actions"> 
                    <button class="update" data-id="${usuario.id}" data-nombre="${usuario.nombre}" data-apellido="${usuario.apellido}" data-mail="${usuario.mail}" data-cel="${usuario.cel}" > Actualizar  </button> 
